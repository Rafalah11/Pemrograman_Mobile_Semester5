...
class GetConnectController extends GetConnect {
  ...
  static const String _apiKey =
      '63a0dcceb44e42f2bfe3c3501a817e5d'; // Ganti ke API KEY yang sudah didapat
  static const String _category = 'business';
  static const String _country = 'us'; //us maksudnya United States ya

  RxList<ArticleElement> articles =
      RxList<ArticleElement>([]); // Perubahan di sini
    ...
    try {
      ...
      if (response.statusCode == 200) {
        final articlesResult =
            Article.fromJson(response.body); // Perubahan di sini
